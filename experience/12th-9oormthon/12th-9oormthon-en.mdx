...
This article is not only a personal recollection of my first hackathon, but also a helpful guide for prospective Goormoners.
...
In general, accuracy and speed are inversely proportional. However, in the real world, you need to set deadlines and develop products accordingly.
...
When writing the page and preparing the script, I used the
<Callout type="info">.
  The bio is not about introducing yourself, it's about introducing the future the listener can gain from your involvement.
</Callout>.
...
The team building time was like a market. There was no system, everyone just asked for their teammates and formed a team.
I had made a list of people I wanted to work with beforehand, and luckily I didn't have much trouble organizing the team. If you're going to participate in Goormathon, I would recommend that you think about who you want to team up with and what ideas you want to bring to the table during the team building time.
There is a certain amount of "luck" that comes into play during this time. We were often teamed up with people who were relatively close to us based on our initially randomized seats.
...
We chose the topic based on a newspaper article that was published on the day of the hackathon.
...
<Callout reference="When the elderly in Jeju feel happy" link="https://www.jejunews.com/news/articleView.html?idxno=2215293">
  ...
  In short, older adults on Jeju Island have their children at the center of their happiness, but they are relationship-oriented rather than dependent, explore independence and meaning in life through work, and value their children's health and happiness more than their own.
</Callout>
...
After the topic was selected, we had a meeting to develop a specific service, specifying the API, DB, and making a front-end development plan according to the designer's screen design.
...
During this development, I noticed that our service kept re-rendering every few seconds.
I realized the problem around 4am and worked on it for about 2 hours until I realized that our service was running in development mode.
...
We had to find a way around the difficulty of crampolining our deployment, which was to spin up a static server with nginx, which is what we originally wanted to do.
...
We thought about it a lot, but we regretted that we didn't make our logic sufficiently clear enough to explain it.
...
I was proud of our team for coming up with such a great result in such a short time.

## Outro

True to the values of Goormtone, I was able to experience and learn a lot in a very short period of time.

As it was my first hackathon, I had a lot of inexperience, but fortunately, I was able to meet good teammates, build memories, and have a good time.
We worked so hard that we forgot to sleep at night, and we learned a lot in the process. I couldn't have done it without my team.
...
The process of intensely thinking and developing ideas with teammates is purely enjoyable. This fact alone made it worthwhile.
