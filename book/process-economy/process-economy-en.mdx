---
title: The Process Economy - Kazuhiro Obara
publishedAt: 2022-09-12T00:00:00.000Z
draft: false
mode: Y
description: After reading Process Economy
tags:
  - obara kazuhiro
preview: /banner/book/process-economy.webp
---

<Youtube id="3GIuoo_z0xQ" />

## Quality alone is not enough to differentiate anymore.
...
Take the restaurant example. Nowadays, it seems like you can walk into any restaurant and still get a decent level of flavor. There are many reasons for this, but from a process economy perspective, there is a lot more information on the internet about how to run a restaurant and how to make delicious food.
...
This younger generation of 30-somethings and under is what the author refers to as the "Generation Without Desire".
...
Instead, we want to buy things that we really like, things that resonate with the vision of the company and the life and story of the producer.

<Callout type="info">
  They want to buy things they love, and they want to connect with the lives and stories of the producers.
  They're not just consuming "outputs," they're attracted to the act of sharing "processes."
</Callout>
...
problems and skills, and we've made a lot of progress together. Sometimes I learn new information
